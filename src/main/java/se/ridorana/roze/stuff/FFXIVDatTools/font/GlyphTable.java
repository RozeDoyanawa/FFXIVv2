...
public class GlyphTable {
	...
	public GlyphTable(DatSegment segment) throws UnsupportedEncodingException {
		...
		int unk1 = map.get(32 + 20);
		int unk2 = map.get(32 + 21);
		int unk3 = map.get(32 + 22);
		int unk4 = map.get(32 + 23);
		int rowHeight = map.get(32 + 24);
