...
public final class ImageDecoding {
	 ...
	 */
	public static final BufferedImage decodeImage4444(final byte[] data, final int targetWidth, final int targetHeight, final int compressedWidth, final int compressedHeight) throws ImageDecodingException {
	 ...
	 * @throws ImageDecodingException
	 */
	public static final BufferedImage decodeImage4444split(final byte[] data, final int targetWidth, final int targetHeight, final int compressedWidth, final int compressedHeight) throws ImageDecodingException {
	 ...
	 * @throws ImageDecodingException
	 */
	public static final BufferedImage decodeImageDX1(final byte[] data, final int targetWidth, final int targetHeight, final int compressedWidth, final int compressedHeight) throws ImageDecodingException {
		final BufferedImage img = new BufferedImage(targetWidth, targetHeight, BufferedImage.TYPE_INT_ARGB);
		if (data.length < ((targetHeight * targetWidth) / 2)) {
			throw new ImageDecodingException("Data too short");
		}
	 ...
	 * @throws ImageDecodingException
	 */
	public static final BufferedImage decodeImageDX3(final byte[] data, final int targetWidth, final int targetHeight, final int compressedWidth, final int compressedHeight) throws ImageDecodingException {
		final BufferedImage img = new BufferedImage(targetWidth, targetHeight, BufferedImage.TYPE_INT_ARGB);
		if (data.length < ((targetHeight * targetWidth) / 2)) {
			throw new ImageDecodingException("Data too short");
		}
	 ...
	 * @throws ImageDecodingException
	 */
	public static final BufferedImage decodeImageDX5(final byte[] data, final int targetWidth, final int targetHeight, final int compressedWidth, final int compressedHeight) throws ImageDecodingException {
		final BufferedImage img = new BufferedImage(targetWidth, targetHeight, BufferedImage.TYPE_INT_ARGB);
		if (data.length < ((targetHeight * targetWidth) / 2)) {
			throw new ImageDecodingException("Data too short");
		}
	...
	public static BufferedImage decodeImageRaw(final byte[] data, final int uncompressedWidth, final int uncompressedHeight, final int i, final int j) throws ImageDecodingException {
	 ...
	 * @throws ImageDecodingException
	 */
	public static final BufferedImage decodeImageRGBA(final byte[] data, final int targetWidth, final int targetHeight, final int compressedWidth, final int compressedHeight) throws ImageDecodingException {
		final BufferedImage img = new BufferedImage(targetWidth, targetHeight, BufferedImage.TYPE_INT_ARGB);
	 ...
	 * @throws ImageDecodingException
	 */
	public static final BufferedImage decodeImageTester(final byte[] data, final int targetWidth, final int targetHeight, final int compressedWidth, final int compressedHeight) throws ImageDecodingException {
		final BufferedImage img = new BufferedImage(targetWidth, targetHeight, BufferedImage.TYPE_INT_ARGB);
		if (data.length < (targetHeight * targetWidth * 2)) {
			throw new ImageDecodingException("Data too short");
		}
